...
public class CartesianPanel extends JPanel {
    ...
    private final List<LineSegment> specialSegments = new LinkedList<>();
    ...
    public void drawSegments(List<LineSegment> newSegments){
    ...
    public void drawSpecialSegments(List<LineSegment> newSpecialSegments){
        specialSegments.addAll(newSpecialSegments);
        repaint();
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        for(LineSegment s : segments){
            drawLineSegmentImpl(s.getStart(), s.getEnd(), s.getId(), g);
        }

        // draw special segments and points
        g.setColor(Color.RED);
        for(Point p : specialPoints){
            drawPointImpl(p, g);
        }
        for(LineSegment s : specialSegments){
            drawLineSegmentImpl(s.getStart(), s.getEnd(), s.getId(), g);
        }
...
//        }
    ...
    private void drawLineSegmentImpl(Point start, Point end, Integer id, Graphics g){
